...
class AIPreset:
    ...
    EASY = {
        ...
        "opponent_blocking": 0.2,
        "center_penalty": -1.0,
        "figure_opportunity": 50,
        "structure_connection": 5,
        "unoccupied_bonus": 15,
        "completion_ratio_bonuses": [10, 20, 30, 45],
        "size_penalties": [-10, -20, -40],
        "field_bonuses": [5, 10, 15],
        "city_bonuses": [15, 25, 35],
        "road_bonuses": [10, 20, 30],
        "monastery_bonuses": [30, 45, 60]
    }
    ...
    NORMAL = {
        ...
        "conservation_threshold": 5,
        "placement_threshold": 250,
        "opponent_blocking": 0.6,
        "center_penalty": 0.5,
        "figure_opportunity": 100,
        "structure_connection": 15,
        "unoccupied_bonus": 30,
        "completion_ratio_bonuses": [30, 50, 75, 100],
        "size_penalties": [-5, -10, -20],
        "field_bonuses": [10, 20, 30],
        "city_bonuses": [30, 50, 65],
        "road_bonuses": [25, 35, 50],
